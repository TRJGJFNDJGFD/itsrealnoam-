...
| `STALE_AFTER_MS`     | If no heartbeat arrives within this window, the network is reported offline instead of serving old numbers as live. Default `30000` — kept generous because Vercel Blob writes aren't instantly consistent across function invocations. |
